...
class GithubRepoAdapterProjectTest < GithubRepoAdapterBaseTest
  def test_list_projects
    VCR.use_cassette("github_repo_adapter/list_projects") do
  ...
  def test_find_project_by_name
    VCR.use_cassette("github_repo_adapter/find_project_by_name") do
  ...
  def test_find_project_by_full_name
    VCR.use_cassette("github_repo_adapter/find_project_by_full_name") do
  ...
  def test_find_project_not_found
    VCR.use_cassette("github_repo_adapter/find_project_not_found") do
  ...
  def test_project_factory
    VCR.use_cassette("github_repo_adapter/project_factory") do
  ...
  def test_create_project
    ...
    VCR.use_cassette("github_repo_adapter/create_project") do
  ...
  def test_delete_project
    ...
    VCR.use_cassette("github_repo_adapter/delete_project") do
