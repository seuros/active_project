...
class BasecampWebhookTest < ActiveSupport::TestCase
  ...
  test "parses todo_created webhook" do
    payload = {
      ...
      "recording" => {
        "id" => 12345, "status" => "created", "type" => "Todo",
    ...
    assert_equal 12345, event.event_object_id
  ...
  test "parses todo_completion_changed webhook" do
     payload = {
      ...
      "recording" => {
        "id" => 12346, "status" => "updated", "type" => "Todo",
    ...
    assert_equal :issue, event.object_kind
    assert_equal 12346, event.event_object_id
  ...
  test "parses comment_created webhook" do
    payload = {
      ...
      "recording" => {
        ...
        "parent" => { "id" => 12347, "type" => "Todo" }, # Parent is the Todo
